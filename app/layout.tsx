...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
 return <html lang="es"><body><a className="skip-link" href="#contenido-principal">Saltar al contenido principal</a><MetaPixelRuntime/><ServiceWorkerRegister/><CartProvider><TopBanner/><Header/><main id="contenido-principal" tabIndex={-1}>{children}</main><PaymentDeliveryFix/><WhatsAppButton/><MobileCustomerNav/><SiteFooter/></CartProvider></body></html>;
}
