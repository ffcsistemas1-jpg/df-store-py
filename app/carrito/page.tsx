  ...
  return (
    <main className="df-cart-page">
      <style>{`
        ...
        .df-cart-page .df-cart-header{display:block!important;width:100%!important;margin:0 0 24px!important;padding:0!important;position:relative!important;clear:both!important}
        ...
        .df-cart-page h1{display:block!important;width:100%!important;margin:0 0 12px!important;padding:0!important;font:700 clamp(46px,7vw,72px)/1 Georgia,serif!important;color:#21171a!important;white-space:normal!important;overflow:visible!important}
        .df-cart-page .df-subtitle{display:block!important;width:100%!important;margin:0!important;color:#71696c!important;font:18px/1.45 Arial,sans-serif!important}
        .df-cart-page .df-continue{display:inline-flex!important;position:static!important;width:auto!important;max-width:100%!important;margin:18px 0 0!important;padding:0!important;clear:both!important;color:#98234d!important;font:800 16px/1.3 Arial,sans-serif!important;text-decoration:none!important;white-space:normal!important}
        .df-cart-page .df-layout{display:grid!important;grid-template-columns:minmax(0,1fr) 340px!important;gap:24px!important;align-items:start!important;width:100%!important;margin:0!important}
        ...
        .df-cart-page .df-item{display:grid!important;grid-template-columns:112px minmax(0,1fr)!important;grid-template-rows:auto auto auto!important;gap:12px 16px!important;width:100%!important;min-width:0!important;margin:0!important;padding:16px!important;background:#fff!important;border:1px solid #eadfe0!important;border-radius:18px!important;overflow:hidden!important}
        ...
        .df-cart-page .df-info{display:block!important;grid-column:2!important;grid-row:1!important;width:100%!important;min-width:0!important;margin:0!important;padding:0!important}
        .df-cart-page .df-name{display:block!important;width:100%!important;min-width:0!important;margin:0 0 7px!important;color:#21171a!important;font:900 19px/1.25 Arial,sans-serif!important;text-decoration:none!important;overflow-wrap:break-word!important;word-break:normal!important;white-space:normal!important}
        ...
        .df-cart-page .df-summary{display:block!important;width:100%!important;margin:0!important;padding:24px!important;background:#fff!important;border:1px solid #eadfe0!important;border-radius:18px!important;position:sticky!important;top:90px!important}
        ...
        @media(max-width:600px){.df-cart-page{width:100%!important;padding:22px 12px 120px!important}.df-cart-page h1{font-size:50px!important}.df-cart-page .df-subtitle{font-size:16px!important}.df-cart-page .df-item{grid-template-columns:92px minmax(0,1fr)!important;gap:12px!important;padding:12px!important}.df-cart-page .df-photo{width:92px!important;height:92px!important;min-width:92px!important}.df-cart-page .df-name{font-size:17px!important;overflow-wrap:normal!important}.df-cart-page .df-unit-price{font-size:16px!important}.df-cart-page .df-actions strong{font-size:18px!important}.df-cart-page .df-summary{padding:18px!important}}
      `}</style>
      {!items.length ? (
        <section className="df-cart-header"><span className="df-kicker">COMPRA</span><h1>Carrito</h1><p className="df-subtitle">Tu carrito está vacío.</p><Link className="df-continue" href="/catalogo">← Ir al catálogo</Link></section>
      ) : (
        <>
          <header className="df-cart-header"><span className="df-kicker">COMPRA</span><h1>Carrito</h1><p className="df-subtitle">Revisá tus productos antes de continuar.</p><Link className="df-continue" href="/catalogo">← Seguir comprando</Link></header>
          ...
          <div className="df-layout">
            <section className="df-list" aria-label="Productos del carrito">
              {items.map((item) => (
                <article className="df-item" key={item.id}>
                  ...
                  <div className="df-info"><Link className="df-name" href={`/catalogo/${item.id}`}>{item.name}</Link><div className="df-unit-price">{money(item.price)} <small>por unidad</small></div><div className="df-stock">{item.stock > 0 ? `${item.stock} disponibles` : "Sin stock"}</div></div>
                  <div className="df-qty"><span>Cantidad</span><div className="df-stepper"><button type="button" disabled={item.quantity <= 1} onClick={() => update(item.id, item.quantity - 1)}>−</button><input type="number" min={1} max={item.stock || 1} value={item.quantity} onChange={(e) => update(item.id, Number(e.target.value) || 1)} /><button type="button" disabled={item.quantity >= item.stock} onClick={() => update(item.id, item.quantity + 1)}>+</button></div></div>
            ...
            <aside className="df-summary"><h2>Resumen del pedido</h2><div className="df-summary-row"><span>Subtotal</span><strong>{money(subtotal)}</strong></div><p>El costo de entrega se calculará en el checkout.</p><Link className="df-primary" href="/checkout">Continuar al checkout</Link><Link className="df-summary-link" href="/catalogo">Seguir comprando</Link></aside>
          </div>
        </>
      )}
    </main>
