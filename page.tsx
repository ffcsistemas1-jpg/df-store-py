...
export default function Checkout(){
 ...
 const [locationStatus,setLocationStatus]=useState(""); const [showNote,setShowNote]=useState(false); const sessionRef=useRef(""); const draftReady=useRef(false); const [restoredDraft,setRestoredDraft]=useState(false); const initiateTracked=useRef(false); const formRef=useRef(form);
